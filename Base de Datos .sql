...
(DEFAULT,"Dark Souls es un RPG de acción en tercera persona, que se caracteriza por una atmósfera oscura y una dificultad muy por encima de los estándares actuales.","/images/posts/dark_souls.jpeg","2021-08-17",2,default,default),
(DEFAULT,"Para jugar con amigos, vaya a Amistosos en la sección Jugar. Una vez dentro, puedes jugar en el sofá o enfrentarte a un amigo en línea. Luego confirma qué equipo estás usando y selecciona el tipo de partido que deseas.","/images/posts/fifa_22.jpeg","2021-08-10",3,default,default),
...
(DEFAULT,"Estaría bueno que uno pueda competir contra otros para ver quien tiene el mejor imperio de comida.","2021-08-15",1,3,default,default),
(DEFAULT,"Hay un truco que los va a ayudar a pasar de forma más rápida los niveles. Primero usa las máquinas de cocina y deja al final las mejoras de ingredientes.","2021-08-15",1,4,default,default),
(DEFAULT,"No me gusta que sea tan repetitivo.","2021-08-15",1,5,default,default),
(DEFAULT,"Muy violento para los niños.","2021-08-17",2,1,default,default),
(DEFAULT,"Es uno de los mejores juegos de aventura que he jugado en mi vida.","2021-08-17",2,3,default,default),
(DEFAULT,"Sin duda lo mejor del juego, es muy envolvente y los temas son muy épicos en las batallas contra los bosses.","2021-08-17",2,3,default,default),
(DEFAULT,"Con respecto a la innovación, buen apartado sin duda ya que es uno de los juegos más influyentes de la última década, siendo su fórmula una de las más copiadas sin éxito por otros estudios.","2021-08-17",2,5,default,default),
(DEFAULT,"Me gustaba mucho más la actualización anterior.","2021-08-10",3,1,default,default),
...
(DEFAULT,"Me gustaría que en el próximo lanzamiento innovaran más en las funcionalidades existentes.","2021-08-10",3,5,default,default),
...
(DEFAULT,"Este juego no aporta nada que no se haya visto antes, todos los juegos de su estilo son exactamente iguales, solo cambian los gráficos y algunas otras cosas.","2021-08-27",4,2,default,default),
(DEFAULT,"Me gusta poder estar conectado con mis amigos y jugar con o contra ellos.","2021-08-27",4,4,default,default),
(DEFAULT,"No me gustó el juego. Muy violento.","2021-08-27",4,5,default,default),
(DEFAULT,"League of Legends ha sido mi asignatura pendiente durante prácticamente una década.","2021-08-03",5,1,default,default),
(DEFAULT,"Nunca jugué al juego pero con la cantidad de videos que están subiendo me están motivando a hacerlo.","2021-08-03",5,2,default,default),
(DEFAULT,"Buen juego, el contenido, apartado gráfico y las mecánicas son geniales.","2021-08-03",5,3,default,default), 
(DEFAULT,"Solo lo recomiendo si vas a jugar con otros cuatro amigos y así evitais encontraros con jugadores extraños en vuestro mismo equipo.","2021-08-03",5,4,default,default),
(DEFAULT,"El clásico juego que nunca pasa de moda.","2021-08-30",6,5,default,default),
(DEFAULT,"Me gustaría poder aprender los trucos que hace el youtuber santiagotuyo.","2021-08-30",6,4,default,default),
(DEFAULT,"Me parece que Nintendo ya pasó de moda y no logra sacar un juego disruptivo hace años.","2021-08-30",6,4,default,default),
(DEFAULT,"Mario fue el primer video juego que jugué en mi vida.","2021-08-30",6,2,default,default),
(DEFAULT,"Minecraft también les enseña a mis hijos lógica, resolución de problemas, fijación de objetivos.","2021-08-23",7,4,default,default),
(DEFAULT,"Me encanta poder crear mi propia ciudad y a la misma vez que mis amigos puedan colaborar conmigo haciéndola.","2021-08-23",7,4,default,default),
(DEFAULT,"No me gusta el arte del juego.","2021-08-23",7,3,default,default),
(DEFAULT,"Me parece un juego histórico.","2021-08-23",7,1,default,default),
(DEFAULT,"Uno de los videojuegos que revolucionó el mercado del gaming.","2021-08-09",8,1,default,default),
...
(DEFAULT,"Es un buen juego, pero tenía potencial para ser histórico.","2021-08-19",9,1,default,default),
(DEFAULT,"Me encanta el diseño artístico de este juego.","2021-08-19",9,1,default,default),
(DEFAULT,"La música es genial.","2021-08-19",9,3,default,default),
(DEFAULT,"¿Cómo hiciste para llegar al nivel 50? Estoy atascada en el 49 hace un mes y no se como ganarlo.","2021-08-19",9,5,default,default),
(DEFAULT,"Me gusto mucho el juego y me parecen geniales los nuevos desarrollos que está haciendo Etermax.","2021-08-21",10,1,default,default),
(DEFAULT,"Me encanta poder aprender de forma divertida mientras juego.","2021-08-21",10,2,default,default),
(DEFAULT,"Me gustaría que hubiera una sección para que uno cree su propio Avatar.","2021-08-21",10,3,default,default),
(DEFAULT,"Estaría bueno que den premios físicos en el ranking.","2021-08-21",10,3,default,default);
