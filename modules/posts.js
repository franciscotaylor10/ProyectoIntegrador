let posteos ={
    lista:[
        ...
        {
            id: 3,
            descripcion: "Para jugar con amigos, vaya a Amistosos en la sección Jugar. Una vez dentro, puedes jugar en el sofá o enfrentarte a un amigo en línea. Luego confirma qué equipo estás usando y selecciona el tipo de partido que deseas.",
            imagen: "/images/posts/fifa_22.jpeg",
            fecha: "2021 - 08 - 10",
            usuarioId: 3
        ...
        },
        {
            ...
            imagen: "/images/posts/league_of_legends.jpeg",
            fecha: "2021 - 08 - 03",
            usuarioId: 5
        ...
        {
            id: 7,
            descripcion: "Minecraft es un videojuego de mundo abierto donde la exploración y las construcciones son fundamentales. Al ser un videojuego de mundo abierto, no tiene una misión concreta (salvo alguno de sus modos de juego) y consiste en la construcción libre mediante el uso de cubos con texturas tridimensionales.",
            imagen: "/images/posts/minecraft.jpeg",
            fecha: "2021 - 08 - 23",
            usuarioId: 2
        ...
        {
            id: 8,
            descripcion: "El videojuego Pokémon consiste en personificar el papel de un entrenador de criaturas pokémon. Hoy en día existen seis generaciones de estos monstruos, siendo los primeros y más conocidos Charizard de Pokémon rojo; Venusaur, de Pokémon verde, y Pikachu, de Pokémon amarillo.",
            imagen: "/images/posts/pokemon.jpeg",
            fecha: "2021 - 08 - 09",
            usuarioId: 3
        },
        {
            id: 9,
            descripcion: "SimCity es una serie de videojuegos de construcción de ciudades desarrollada y publicada por Maxis (actualmente una división de Electronic Arts) en sus primeros juegos. La temática de los juegos de la serie se enfoca en la creación, gestión y evolución de ciudades. El juego consiste exactamente en crear para abastecer.",
            imagen: "/images/posts/sim_city.jpeg",
            fecha: "2021 - 08 - 19",
            usuarioId: 4
